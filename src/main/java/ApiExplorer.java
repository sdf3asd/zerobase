...
public static void main(String[] args) throws IOException {
	...
	for(int i=1; i<=18000; i+=1000){
StringBuilder urlBuilder = new StringBuilder("http://openapi.seoul.go.kr:8088"); 
/*URL*/
urlBuilder.append("/" + URLEncoder.encode("6f6f5a416c776572353369766d6875","UTF-8") ); /*인증키
...
JsonArray arr = obj.get("TbPublicWifiInfo").getAsJsonObject()
